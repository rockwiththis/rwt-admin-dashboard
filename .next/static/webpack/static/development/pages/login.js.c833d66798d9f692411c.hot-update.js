...
function (_Component) {
  ...
  function LoginForm(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_handleSubmit", function (event) {
      ...
      Object(_api_auth_cognito__WEBPACK_IMPORTED_MODULE_1__["signIn"])({
        username: username,
        password: password,
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_onSuccessfulLogin", function (data) {
      console.log('>> SUCCESSSFULLY LOGGGGED IN!', data);
    });
...
//# sourceMappingURL=login.js.c833d66798d9f692411c.hot-update.js.map