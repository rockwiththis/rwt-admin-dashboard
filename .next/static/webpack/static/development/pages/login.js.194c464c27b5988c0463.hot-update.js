...
function (_Component) {
  ...
  function LoginForm(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_handleInputChange", function (event) {
      console.log('>>> _handleInputChange ', '> event.targate.value', event.target.value); // if (username) this.setState({ username: username })
...
//# sourceMappingURL=login.js.194c464c27b5988c0463.hot-update.js.map