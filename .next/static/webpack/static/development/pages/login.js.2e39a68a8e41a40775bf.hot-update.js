...
function (_Component) {
  ...
  function LoginForm(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_handleInputChange", function (event) {
      console.log('>>> _handleInputChange ', '> username', username, '> password', password, '> event.targate.value', event.target.value);
...
//# sourceMappingURL=login.js.2e39a68a8e41a40775bf.hot-update.js.map