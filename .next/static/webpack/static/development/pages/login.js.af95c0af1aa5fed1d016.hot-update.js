...
function (_Component) {
  ...
  function LoginForm(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_handleInputChange", function (event) {
      console.log('>>> _handleInputChange ', '> username', username, '> password', password, '> event.targate.value', event.target.value); // if (username) this.setState({ username: username })
...
//# sourceMappingURL=login.js.af95c0af1aa5fed1d016.hot-update.js.map